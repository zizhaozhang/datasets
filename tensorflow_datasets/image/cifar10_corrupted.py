...
_FILENAMES = [
    'gaussian_noise.npy', 'shot_noise.npy', 'impulse_noise.npy',
    'defocus_blur.npy', 'glass_blur.npy', 'motion_blur.npy', 'zoom_blur.npy',
    'snow.npy', 'frost.npy', 'fog.npy', 'brightness.npy', 'contrast.npy',
    'elastic_transform.npy', 'pixelate.npy', 'jpeg_compression.npy'
]
_CORRUPTIONS_TO_FILENAMES = dict(zip(_CORRUPTIONS, _FILENAMES))
_DIRNAME = 'CIFAR-10-C'
...
class Cifar10CorruptedConfig(tfds.core.BuilderConfig):
  ...
  def __init__(self, corruption_type='gaussian_noise', severity=1, **kwargs):
    """Constructor.
