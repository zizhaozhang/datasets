...
# for datasets/
GCS_DATASETS_URL = posixpath.join(GCS_URL, "tensorflow-datasets")
GCS_DATASETS_PATH = "datasets"


def is_gcs_dataset_accessible(relative_data_dir):
  url = posixpath.join(GCS_DATASETS_URL, GCS_DATASETS_PATH, relative_data_dir,
                       "dataset_info.json")
